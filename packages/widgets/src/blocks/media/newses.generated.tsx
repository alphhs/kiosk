 ...
 * });
 */
export function useNewsesQuery(
  baseOptions?: Apollo.QueryHookOptions<NewsesQuery, NewsesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<NewsesQuery, NewsesQueryVariables>(
    NewsesDocument,
    options,
  );
}
export function useNewsesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<NewsesQuery, NewsesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<NewsesQuery, NewsesQueryVariables>(
    NewsesDocument,
    options,
  );
}
export function useNewsesSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<NewsesQuery, NewsesQueryVariables>,
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<NewsesQuery, NewsesQueryVariables>(
    NewsesDocument,
    options,
  );
}
...
export type NewsesSuspenseQueryHookResult = ReturnType<
  typeof useNewsesSuspenseQuery
>;
export type NewsesQueryResult = Apollo.QueryResult<
  NewsesQuery,
