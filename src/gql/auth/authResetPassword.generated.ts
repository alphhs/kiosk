...
export type AuthResetPasswordMutation = { __typename?: 'Mutation'; success?: string };

export const AuthResetPasswordDocument = gql`
  mutation authResetPassword($login: String!) {
    success: authResetPassword(input: { login: $login })
  }
`;
