...
export type VoucherMutationVariables = Types.Exact<{
...
export const VoucherDocument = gql`
  mutation voucher($number: String!, $token: String!, $code: String!) {
    useVoucher(input: { number: $number, token: $token, code: $code }) {
      ...currentOrder
    }
  }
  ${CurrentOrderFragmentDoc}
`;
export type VoucherMutationFn = Apollo.MutationFunction<VoucherMutation, VoucherMutationVariables>;

/**
 * __useVoucherMutation__
 *
 * To run a mutation, you first call `useVoucherMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useVoucherMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [voucherMutation, { data, loading, error }] = useVoucherMutation({
 *   variables: {
 ...
 * });
 */
export function useVoucherMutation(baseOptions?: Apollo.MutationHookOptions<VoucherMutation, VoucherMutationVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<VoucherMutation, VoucherMutationVariables>(VoucherDocument, options);
}
export type VoucherMutationHookResult = ReturnType<typeof useVoucherMutation>;
export type VoucherMutationResult = Apollo.MutationResult<VoucherMutation>;
export type VoucherMutationOptions = Apollo.BaseMutationOptions<VoucherMutation, VoucherMutationVariables>;
