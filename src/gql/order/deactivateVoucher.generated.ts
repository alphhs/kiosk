...
export type DeactivateVoucherMutationVariables = Types.Exact<{
  adjustmentId: Types.Scalars['ID']['input'];
  number: Types.Scalars['String']['input'];
  token: Types.Scalars['String']['input'];
}>;

export type DeactivateVoucherMutation = {
  __typename?: 'Mutation';
  deactivateVoucher?: {
    __typename?: 'Order';
    id: string;
...
export const DeactivateVoucherDocument = gql`
  mutation deactivateVoucher($adjustmentId: ID!, $number: String!, $token: String!) {
    deactivateVoucher(input: { adjustmentId: $adjustmentId, number: $number, token: $token }) {
      ...currentOrder
    }
  }
  ${CurrentOrderFragmentDoc}
`;
export type DeactivateVoucherMutationFn = Apollo.MutationFunction<DeactivateVoucherMutation, DeactivateVoucherMutationVariables>;

/**
 * __useDeactivateVoucherMutation__
 *
 * To run a mutation, you first call `useDeactivateVoucherMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeactivateVoucherMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deactivateVoucherMutation, { data, loading, error }] = useDeactivateVoucherMutation({
 *   variables: {
 *      adjustmentId: // value for 'adjustmentId'
 *      number: // value for 'number'
 *      token: // value for 'token'
 *   },
 * });
 */
export function useDeactivateVoucherMutation(
  baseOptions?: Apollo.MutationHookOptions<DeactivateVoucherMutation, DeactivateVoucherMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<DeactivateVoucherMutation, DeactivateVoucherMutationVariables>(DeactivateVoucherDocument, options);
}
export type DeactivateVoucherMutationHookResult = ReturnType<typeof useDeactivateVoucherMutation>;
export type DeactivateVoucherMutationResult = Apollo.MutationResult<DeactivateVoucherMutation>;
export type DeactivateVoucherMutationOptions = Apollo.BaseMutationOptions<
  DeactivateVoucherMutation,
  DeactivateVoucherMutationVariables
>;
