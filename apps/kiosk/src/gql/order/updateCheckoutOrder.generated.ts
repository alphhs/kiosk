...
export type UpdateCheckoutOrderMutationVariables = Types.Exact<{
  input: Types.UpdateCheckoutOrderInput;
}>;

export type UpdateCheckoutOrderMutation = {
  __typename?: 'Mutation';
  updateCheckoutOrder?: {
    __typename?: 'Order';
    id: string;
...
export const UpdateCheckoutOrderDocument = gql`
  mutation updateCheckoutOrder($input: updateCheckoutOrderInput!) {
    updateCheckoutOrder(input: $input) {
      ...currentOrder
    }
  }
  ${CurrentOrderFragmentDoc}
`;
export type UpdateCheckoutOrderMutationFn = Apollo.MutationFunction<
  UpdateCheckoutOrderMutation,
  UpdateCheckoutOrderMutationVariables
>;

/**
 * __useUpdateCheckoutOrderMutation__
 *
 * To run a mutation, you first call `useUpdateCheckoutOrderMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCheckoutOrderMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCheckoutOrderMutation, { data, loading, error }] = useUpdateCheckoutOrderMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateCheckoutOrderMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateCheckoutOrderMutation, UpdateCheckoutOrderMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UpdateCheckoutOrderMutation, UpdateCheckoutOrderMutationVariables>(
    UpdateCheckoutOrderDocument,
    options,
  );
}
export type UpdateCheckoutOrderMutationHookResult = ReturnType<typeof useUpdateCheckoutOrderMutation>;
export type UpdateCheckoutOrderMutationResult = Apollo.MutationResult<UpdateCheckoutOrderMutation>;
export type UpdateCheckoutOrderMutationOptions = Apollo.BaseMutationOptions<
  UpdateCheckoutOrderMutation,
  UpdateCheckoutOrderMutationVariables
>;
